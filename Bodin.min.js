...
1).replace("[","").replace("]","");return{word:c,occurence:a}};this.apply=function(){for(var a in this.alignments){var b=this._xmlToIds(a);if(void 0==b)console.log("No ids specified for "+a);else{var c=1,e;for(e in this.alignments[a].json){var d=this.alignments[a].json[e];this._mark(b.body,c,d.body);this._mark(b.target,c,d.target);c++}}}};this._xmlToIds=function(a){for(var b in this.config)if(this.config[b].src==a)return this.config[b].ids};this._mark=function(a,b,c){a="#"+a+" "+("#book-"+c.book)+
" "+("#chapter-"+c.chapter);var e=jQuery(a).html(),d=c.start;c=c.end;var f=e.positions(d.word,!1,!0,!0),d=f[d.occurence-1],f=this._highlightColor(b),e=e.insertAt(d,'<span id="'+b+'" class="align" style="background-color:'+f+'">'),f=e.positions(c.word,!1,!0,!0),d=f[c.occurence-1]+c.word.length,e=e.insertAt(d,"</span>");jQuery(a).html(e)};this._highlightColor=function(a){return this.palette.colors[a%this.palette.colors.length].toAlpha(0.15)};this.loadCheck=function(){for(var a in this.xml)if(!0!=this.alignments[a].loaded)return;
jQuery(window).trigger(this.events.loaded)}};
(function(a){function b(a,b,d){this.elem=a;this.id=d;this.init(a,b)}b.prototype.init=function(c,b){a(this.elem).addClass("bodin");this.options=$.extend({scrollPad:40,blinkAlpha:0.5},b);this.events={milestone:"BodinUI-MILESTONE",align:"BodinUI-ALIGN"};this.start()};b.prototype.start=function(){var c=this;c.makeRoom();c.sizeCheck();c.buildNav();c.tooltips();c.align();void 0!=c.options.milestones&&c.milestones();a(window).resize(function(){c.sizeCheck()})};b.prototype.align=function(){var c=this;a(".align",
c.elem).on("touchstart click",function(b){b.preventDefault();a(window).trigger(c.events.align,[a(this).attr("id")])})};b.prototype.alphaBlink=function(c){var b=this,d=a("#"+c,b.elem),f=b._alphaBlinkColors(d);if(void 0!=f)for(b.blinkCounter=0,c=1;9>=c;c++)setTimeout(function(){a(d).css("background-color",f[b.blinkCounter%f.length]);b.blinkCounter++},500*c)};b.prototype._alphaBlinkColors=function(c){if(void 0!=c&&(c=a(c).css("background-color"),void 0!=c)){var b=c.substring(c.indexOf("(")+1,c.indexOf(")")-
1).split(",");b[3]=this.options.blinkAlpha;b="rgba("+b.join(",")+")";return[c,b]}};b.prototype.makeRoom=function(){var c=a(".bodin").length,b=new Styler,c=parseInt(100/c);b.add({".bodin":"width: "+c+"%"})};b.prototype.sizeCheck=function(){450>a(this.elem).width()?a(this.elem).addClass("slim"):a(this.elem).removeClass("slim")};b.prototype.milestones=function(){var c=this,b=0,d=c.options.milestones;a("p",c.elem).each(function(){var c=d[b%d.length];b++;a(this).prepend('<a href="" class="milestone" id="stone-'+
b+'">'+c+"</a>")});a(".milestone").on("touchstart click",function(b){b.preventDefault();a(window).trigger(c.events.milestone,[a(this).attr("id")])})};b.prototype.goTo=function(a){a=$("#"+a,this.elem).position();if(void 0!=a){a=a.top-this.options.scrollPad;var b=$(".work",this.elem).scrollTop();$(".work",this.elem).animate({scrollTop:b+a},1E3)}};b.prototype.buildNav=function(){var c=a(this.elem).attr("id");a(this.elem).prepend('\t\t\t<div id="sidecart_'+c+'"></div>\t\t');var b="<ul>",d=1;a(".edition",
this.elem).each(function(){var c=a(this).attr("id");b+='<li><a href="#'+c+'">Edition -- '+d+"</a></li>";b+="<ul>";d++;var h=1;a(".book",this).each(function(){var c=a(this).attr("id");b+='<li><a href="#'+c+'">Book -- '+h+"</a></li>";b+="<ul>";h++;var d=1;a(".chapter",this).each(function(){var c=a("h1",this).text(),f=a("h2",this).text(),g="Chapter -- "+d;""!=c&&(g="<div>"+c+"</div><div>"+f+"</div>");c=a(this).attr("id");b+='<li><a href="#'+c+'">'+g+"</a></li>";d++});b+="</ul>"});b+="</ul>"});b+="</ul>";
this.sidecart=a("#sidecart_"+c).sidecart({side:"top",inside:!0,views:[{id:c+"-view-1",type:"nav",link:"index",text:b,init:function(){},refresh:function(){}}]}).data("#sidecart_"+c);this.navEvents()};b.prototype.navEvents=function(){var c=this,b=a(c.elem).attr("id");a("#sidecart_"+b+" .nav a",this.elem).on("touchstart click",function(b){b.preventDefault();b=a(this).attr("href").replace("#","");c.sidecart.hide();c.goTo(b)})};b.prototype.tooltips=function(){var b=a(this.elem).attr("id");new Tooltipper("#"+
b+" .work")};a(document).ready(function(a){a.fn.BodinUI=function(e){var d=a(this).selector;return this.each(function(){a.data(this,d,new b(this,e,d))})}})})(jQuery);
