...
String.prototype.smoosh=function(){return this.replace(/(\r\n+|\n+|\r+|\t+)/gm,"")};String.prototype.splice=function(a,b){return this.slice(0,Math.abs(b))+a+this.slice(Math.abs(b))};String.prototype.stripTags=function(){return this.replace(/<\/?[^>]+(>|$)/g,"")};String.prototype.oneSpace=function(){return this.replace(/\s{2,}/g," ")};String.prototype.alphaSpaceOnly=function(){return this.replace(/[^\w\s]/gi,"")};String.prototype.alphaOnly=function(){return this.replace(/[^\w]/gi,"")};
String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.repeat=function(a){return Array(a+1).join(this)};String.prototype.occurs=function(a,b){if(void 0==a)return this.length;a+="";if(0>=a.length)return this.length;for(var c=0,e=0,d=b?1:a.length;;)if(e=this.indexOf(a,e),0<=e)c++,e+=d;else break;return c};
...
!0;for(a in this.config)if(!0!=this.config[a].loaded)return;jQuery(window).trigger(this.events.loaded)}},BodinAlign=function(){if(BodinAlign.prototype._singleton)return BodinAlign.prototype._singleton;BodinAlign.prototype._singleton=this;this.src={};this.alignments={};this.config=null;this.ignoreTag={H1:!0,H2:!0};this.ignoreClass={note:!0,milestone:!0};this.palette=new Palette("secondary");this.events={loaded:"BodinAlign-LOADED"};this.styler=new Styler;this.start=function(a){this.config=a;for(var b in a)this.src[a[b].src]=
1;for(b in this.src)this.alignments[b]={loaded:!1};for(b in this.src)this.get(b)};this.get=function(a){var b=this;jQuery.get(a).done(function(c){b.alignments[a].xml=c;b.alignments[a].loaded=!0;b.alignments[a].json=b.json(c);b.loadCheck()}).fail(function(){console.log("Could not load alignment xml: "+a)})};this.target=function(a){var b=a.lastIndexOf(":")+1,c=a.indexOf("@");if(-1!=c){var e=a.substr(b,c-b).split("."),b=parseInt(e[0]),e=parseInt(e[1]);a=a.substr(c+1,a.length);a=a.split("-");return{book:b,
chapter:e,start:a[0],end:a[1]}}};this.json=function(a){var b=this,c=[];jQuery(a).find("Annotation").each(function(){var a=jQuery(this).find("hasTarget"),a=jQuery(a[0]).attr("rdf:resource"),a=b.target(a);if(void 0==a)return!0;var d=jQuery(this).find("hasBody"),d=jQuery(d[0]).attr("rdf:resource"),d=b.target(d);if(void 0==a)return!0;c.push({target:a,body:d})});return c};this.wordAndOccurence=function(a){var b=a.indexOf("["),c=a.substr(0,b);a=a.substr(b,a.length-1).replace("[","").replace("]","");return{word:c,
occurence:a}};this.apply=function(){for(var a in this.alignments){var b=this.xmlToIds(a);if(void 0==b)console.log("No ids specified for "+a);else{var c=1,e;for(e in this.alignments[a].json){var d=this.alignments[a].json[e];this.mark(b.body,c,d.body);this.mark(b.target,c,d.target);c++}}}};this.xmlToIds=function(a){for(var b in this.config)if(this.config[b].src==a)return this.config[b].ids};this.mark=function(a,b,c){jQuery("#"+a+" "+("#book-"+c.book)+" "+("#chapter-"+c.chapter)).html();var e=c.start;
c=c.end;a=" "+this.colorClass(b);var e=jQuery("span.token.text[data-ref='"+e+"']"),d=jQuery("span.token.text[data-ref='"+c+"']");if(e&&d)for(var e=$(e).nextAll(".token").addBack(),d=!1,f=0;f<e.length&&!d;f++){var h=jQuery(e[f]),g=parseInt(h.attr("data-aligned"))+1;h.attr("data-aligned",g);var k=g="";0==f&&(g=" align-start");h.attr("data-ref")==c&&(k=" align-end");g=this.alignSpan(b,g,k,a);h.wrapInner(g.smoosh());h.attr("data-ref")==c&&(d=!0)}};this.alignSpan=function(a,b,c,e){return'\t\t\t<span \t\t\t\tclass="\t\t\t\t\taligned align-'+
a+b+c+e+'" \t\t\t\tdata-alignId="'+a+'"\t\t\t>\t\t\t</span>'};this.highlightColor=function(a){return this.alphaColor(a,0.15)};this.highlightBlinkColor=function(a){return this.alphaColor(a,0.5)};this.alphaColor=function(a,b){return this.palette.colors[this.colorId(a)].toAlpha(b)};this.colorId=function(a){return a%this.palette.colors.length};this.colorClass=function(a){return"color-"+this.colorId(a)};this.paletteStyles=function(){for(var a={},b=0;b<this.palette.colors.length;b++)a["."+this.colorClass(b)]=
"background-color:"+this.highlightColor(b),a["."+this.colorClass(b)+".blink"]="background-color:"+this.highlightBlinkColor(b),this.styler.add(a)};this.loadCheck=function(){for(var a in this.xml)if(!0!=this.alignments[a].loaded)return;this.paletteStyles();jQuery(window).trigger(this.events.loaded)}};
(function(a){function b(a,b,d){this.elem=a;this.id=d;this.init(a,b)}b.prototype.init=function(c,b){a(this.elem).addClass("bodin");this.id=a(this.elem).attr("id");this.config=$.extend({scrollPad:40,blinkAlpha:0.5,blinkLength:0.5,blinkN:3},b);this.events={milestone:"BodinUI-MILESTONE",align:"BodinUI-ALIGN",switch_highlight:"BodinUI-SWITCH_HIGHLIGHT"};this.alignClick=0;this.start()};b.prototype.optionsUI=function(){return'\t\t\t<div class="switches">\t\t\t\t\t\t\t\x3c!-- Highlights --\x3e\t\t\t\t<h3>Highlights</h3>\t\t\t\t<div class="onoffswitch">\t\t\t\t\t<input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="highlight_'+
...
function(){var c=this;c.makeRoom();c.sizeCheck();c.buildNav();c.tooltips();c.align();void 0!=c.config.milestones&&c.milestones();a(window).resize(function(){c.sizeCheck()})};b.prototype.align=function(){var c=this;a(".aligned",c.elem).on("touchstart click",function(b){b.stopPropagation();b.preventDefault();b=a(this).attr("data-alignId");a(window).trigger(c.events.align,["aligned","data-alignId",b])})};b.prototype.alphaBlink=function(c){var b=this,d=a("#"+c,b.elem);b.blinkCounter=0;c=2*b.config.blinkN;
for(var f=1;f<=c;f++)setTimeout(function(){a(d).toggleClass("blink");b.blinkCounter++},f*b.config.blinkLength*1E3)};b.prototype.filteredAlphaBlink=function(c,b,d){var f=this,h=$("."+c+"["+b+"='"+d+"']",f.elem);f.blinkCounter=0;c=2*f.config.blinkN;for(b=1;b<=c;b++)setTimeout(function(){a(h).toggleClass("blink");f.blinkCounter++},b*f.config.blinkLength*1E3)};b.prototype.makeRoom=function(){var c=a(".bodin").length,b=new Styler,c=parseInt(100/c);b.add({".bodin":"width: "+c+"%"})};b.prototype.sizeCheck=
function(){450>a(this.elem).width()?a(this.elem).addClass("slim"):a(this.elem).removeClass("slim")};b.prototype.milestones=function(){var c=this,b=0,d=c.config.milestones;a("p",c.elem).each(function(){var c=d[b%d.length];b++;a(this).prepend('<a href="" class="milestone" id="stone-'+b+'">'+c+"</a>")});a(".milestone").on("touchstart click",function(b){b.preventDefault();a(window).trigger(c.events.milestone,[a(this).attr("id")])})};b.prototype.goTo=function(a){a=$("#"+a,this.elem).position();if(void 0!=
a){a=a.top-this.config.scrollPad;var b=$(".work",this.elem).scrollTop();$(".work",this.elem).animate({scrollTop:b+a},1E3)}};b.prototype.filteredGoTo=function(a,b,d){a=$("."+a+"["+b+"='"+d+"']",this.elem).position();void 0!=a&&(a=a.top-this.config.scrollPad,b=$(".work",this.elem).scrollTop(),$(".work",this.elem).animate({scrollTop:b+a},1E3))};b.prototype.buildNav=function(){var b=this,e=a(b.elem).attr("id");a(b.elem).prepend('\t\t\t<div id="sidecart_'+e+'"></div>\t\t');var d="<ul>",f=1;a(".edition",
b.elem).each(function(){var b=a(this).attr("id");d+='<li><a href="#'+b+'">Edition -- '+f+"</a></li>";d+="<ul>";f++;var c=1;a(".book",this).each(function(){var b=a(this).attr("id");d+='<li><a href="#'+b+'">Book -- '+c+"</a></li>";d+="<ul>";c++;var e=1;a(".chapter",this).each(function(){var b=a("h1",this).text(),c=a("h2",this).text(),f="Chapter -- "+e;""!=b&&(f="<div>"+b+"</div><div>"+c+"</div>");b=a(this).attr("id");d+='<li><a href="#'+b+'">'+f+"</a></li>";e++});d+="</ul>"});d+="</ul>"});d+="</ul>";
b.sidecart=a("#sidecart_"+e).sidecart({side:"top",inside:!0,views:[{id:e+"-view-1",type:"nav",link:"&hearts; Index",text:d,init:function(){},refresh:function(){}},{id:e+"-view-2",type:"options",link:"&clubs; Options",text:b.optionsUI(),init:function(){b.startOptionsUI()},refresh:function(){}}]}).data("#sidecart_"+e);b.navEvents()};b.prototype.navEvents=function(){var b=this,e=a(b.elem).attr("id");a("#sidecart_"+e+" .nav a",this.elem).on("touchstart click",function(d){d.preventDefault();d=a(this).attr("href").replace("#",
"");b.sidecart.hide();b.goTo(d)})};b.prototype.tooltips=function(){var b=a(this.elem).attr("id");new Tooltipper("#"+b+" .work")};a(document).ready(function(a){a.fn.BodinUI=function(e){var d=a(this).selector;return this.each(function(){a.data(this,d,new b(this,e,d))})}})})(jQuery);
