...
String.prototype.smoosh=function(){return this.replace(/(\r\n+|\n+|\r+|\t+)/gm,"")};String.prototype.oneSpace=function(){return this.replace(/\s{2,}/g," ")};String.prototype.alphaSpaceOnly=function(){return this.replace(/[^\w\s]/gi,"")};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.repeat=function(a){return Array(a+1).join(this)};
String.prototype.occurs=function(a,b){if(void 0==a)return this.length;a+="";if(0>=a.length)return this.length;for(var c=0,e=0,d=b?1:a.length;;)if(e=this.indexOf(a,e),0<=e)c++,e+=d;else break;return c};String.prototype.positions=function(a,b,c,e){a+="";var d=0;b=b?1:a.length;for(var f=[];;){var h=!0,d=this.indexOf(a,d);if(0<=d){if(!0==c)for(var g=d;g<this.length&&"<"!=this[g];g++)">"==this[g]&&(h=!1);!0==e&&!0==this.substr(d-1,d+a.length+1).isAlphaNum()&&(h=!1);!0==h&&f.push(d);d+=b}else break}return f};
String.prototype.insertAt=function(a,b){return this.substr(0,a)+b+this.substr(a)};String.prototype.params=function(){for(var a=this.split("?"),a=a[1].split("&"),b={},c=0,e=a.length;c<e;c++)if(void 0!=a[c]){var d=a[c].split("=");b[d[0]]=d[1]}return b};String.prototype.hasUpper=function(){return/[A-Z]/.test(this)};String.prototype.report=function(){for(var a=this.toLowerCase().split(" "),b={},c=0,e=a.length;c<e;c++){var d=a[c];b[d]=d in b?b[d]+1:1}return b};String.prototype.lines=function(){return this.split("\n")};
...
Culuh.prototype.rgbUpdate=function(){var a,b,c,e=this.h/255,d=this.s/255,f=this.v/255;if(0==d)a=b=c=f;else{var e=6*e,h=e%1,g=f*(1-d),m=f*(1-d*h),d=f*(1-d*(1-h));switch(Math.floor(e)){case 0:a=f;b=d;c=g;break;case 1:a=m;b=f;c=g;break;case 2:a=g;b=f;c=d;break;case 3:a=g;b=m;c=f;break;case 4:a=d;b=g;c=f;break;case 5:a=f,b=g,c=m}}this.r=parseInt(255*a);this.g=parseInt(255*b);this.b=parseInt(255*c)};Culuh.prototype.hex=function(a){return(void 0==a?"":a)+this.rHex()+this.gHex()+this.bHex()};
...
!0;for(a in this.config)if(!0!=this.config[a].loaded)return;jQuery(window).trigger(this.events.loaded)}},BodinAlign=function(){if(BodinAlign.prototype._singleton)return BodinAlign.prototype._singleton;BodinAlign.prototype._singleton=this;this.src={};this.alignments={};this.config=null;this.ignoreTag={H1:!0,H2:!0};this.ignoreClass={note:!0,milestone:!0};this.palette=new Palette("primary");this.events={loaded:"BodinAlign-LOADED"};this.start=function(a){this.config=a;for(var b in a)this.src[a[b].src]=
1;for(b in this.src)this.alignments[b]={loaded:!1};for(b in this.src)this._get(b)};this._get=function(a){var b=this;jQuery.get(a).done(function(c){b.alignments[a].xml=c;b.alignments[a].loaded=!0;b.alignments[a].json=b._json(c);b.loadCheck()}).fail(function(){console.log("Could not load alignment xml: "+a)})};this._target=function(a){var b=a.lastIndexOf(":")+1,c=a.indexOf("@");if(-1!=c){var e=a.substr(b,c-b).split("."),b=parseInt(e[0]),e=parseInt(e[1]);a=a.substr(c+1,a.length);c=a.split("-");a=this._wordAndOccurence(c[0]);
c=this._wordAndOccurence(c[1]);return{book:b,chapter:e,start:a,end:c}}};this._json=function(a){var b=this,c=[];jQuery(a).find("Annotation").each(function(){var a=jQuery(this).find("hasTarget"),a=jQuery(a[0]).attr("rdf:resource"),a=b._target(a);if(void 0==a)return!0;var d=jQuery(this).find("hasBody"),d=jQuery(d[0]).attr("rdf:resource"),d=b._target(d);if(void 0==a)return!0;c.push({target:a,body:d})});return c};this._wordAndOccurence=function(a){var b=a.indexOf("["),c=a.substr(0,b);a=a.substr(b,a.length-
1).replace("[","").replace("]","");return{word:c,occurence:a}};this.apply=function(){for(var a in this.alignments){var b=this._xmlToIds(a);if(void 0==b)console.log("No ids specified for "+a);else{var c=1,e;for(e in this.alignments[a].json){var d=this.alignments[a].json[e];this._mark(b.body,c,d.body);this._mark(b.target,c,d.target);c++}}}};this._xmlToIds=function(a){for(var b in this.config)if(this.config[b].src==a)return this.config[b].ids};this._mark=function(a,b,c){var e=this;a="#"+a+" "+("#book-"+
c.book)+" "+("#chapter-"+c.chapter)+" *";var d=c.start,f=c.end,h=this._highlightColor(b),g=parseInt(d.occurence),m=parseInt(f.occurence);jQuery(a).each(function(){var a=jQuery(this).get(0).tagName,c=jQuery(this).attr("class");if(!0==e.ignoreTag[a]||void 0!=c&&(c=c.replace(".",""),!0==e.ignoreClass[c]))return 1;for(var c=a=!1,l=jQuery(this).html().replace(/\n/g," ").split(" "),k=0,p=l.length;k<p;k++){var n=l[k];if(0==n.indexOf("<"))for(;-1==n.indexOf(">")&&k<p;)k++;else if(n=n.stripTags().alphaOnly(),
n==d.word&&!1==a&&(1==g&&(a=!0,l[k]='<span id="align-'+b+'" class="align" style="background-color:'+h+'">'+l[k]),g--),n==f.word&&!1==c&&(1==m&&(c=!0,l[k]+="</span>"),m--),!0==a&&!0==c)break}console.log(l.join(" "));jQuery(this).html(l.join(" "))})};this._highlightColor=function(a){return this.palette.colors[a%this.palette.colors.length].toAlpha(0.15)};this.loadCheck=function(){for(var a in this.xml)if(!0!=this.alignments[a].loaded)return;jQuery(window).trigger(this.events.loaded)}};
