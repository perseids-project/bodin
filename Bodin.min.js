...
BodinAlign=function(){if(BodinAlign.prototype._singleton)return BodinAlign.prototype._singleton;BodinAlign.prototype._singleton=this;this.src={};this.alignments={};this.config=null;this.ignoreTag={H1:!0,H2:!0};this.ignoreClass={note:!0,milestone:!0};this.palette=new Palette("primary");this.events={loaded:"BodinAlign-LOADED"};this.start=function(a){this.config=a;for(var b in a)this.src[a[b].src]=1;for(b in this.src)this.alignments[b]={loaded:!1};for(b in this.src)this._get(b)};this._get=function(a){var b=
